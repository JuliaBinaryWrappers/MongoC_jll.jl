...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import MongoC_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("90100e71-7732-535a-9be7-2e9affd1cfc1"))
platforms = [Pkg.Artifacts.unpack_platform(e, "MongoC", artifacts_toml) for e in artifacts["MongoC"]]
...
if best_platform === nothing
    @debug("Unable to load MongoC; unsupported platform $(triplet(platform_key_abi()))")
else
