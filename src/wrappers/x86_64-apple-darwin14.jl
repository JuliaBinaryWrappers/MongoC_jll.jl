# Autogenerated wrapper script for MongoC_jll for x86_64-apple-darwin14
...
const libbson_splitpath = ["lib", "libbson-1.0.0.dylib"]
...
const libbson = "@rpath/libbson-1.0.0.dylib"


# Relative path to `libmongoc`
const libmongoc_splitpath = ["lib", "libmongoc-1.0.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libmongoc = "@rpath/libmongoc-1.0.0.dylib"
