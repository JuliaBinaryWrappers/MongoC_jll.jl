# Autogenerated wrapper script for MongoC_jll for x86_64-w64-mingw32
...
const libbson_splitpath = ["bin", "libbson-1.0.dll"]
...
const libbson = "libbson-1.0.dll"


# Relative path to `libmongoc`
const libmongoc_splitpath = ["bin", "libmongoc-1.0.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libmongoc = "libmongoc-1.0.dll"
